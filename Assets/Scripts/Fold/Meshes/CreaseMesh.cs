...
namespace Origami_Mesh
{
    ...
    {
        public Vector3 Vertex => Mesh.MeshVertices.GetMeshVertexAt(m_meshIdx).Vertex;
    ...
    public class Crease : IFoldMeshCallbacks
    {
        ...
        public MeshVertex GetMeshVertexAt(eCreaseVertices ver)
        {
            ...
            switch (ver)
            {
                case eCreaseVertices.Bottom0: return m_creases[0].MeshVertices.GetMeshVertexAt(0);      // Crease0:Idx0
                case eCreaseVertices.Bottom1: return m_creases[0].MeshVertices.GetMeshVertexAt(1);      // Crease0:Idx1
                case eCreaseVertices.Top1:    return m_creases[0].MeshVertices.GetMeshVertexAt(2);      // Crease0:Idx2
                case eCreaseVertices.Top0:    return m_creases[1].MeshVertices.GetMeshVertexAt(2);      // Crease1:Idx2
                default:
                    throw new System.ArgumentOutOfRangeException();
            }
        }
