...
{	
	...
	sealed public class MeshFoldMachine
	{
		...
		{			
			...
			(int m1Idx, int m2Idx) getIndices1or2 (OrigamiMesh mesh1, OrigamiMesh mesh2) => (mesh1.MeshVertices.ConnectedToCreaseList[1] ? 1 : 2, mesh2.MeshVertices.ConnectedToCreaseList[1] ? 1 : 2);
